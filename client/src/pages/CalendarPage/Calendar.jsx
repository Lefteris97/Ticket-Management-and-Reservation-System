...
//      // `http://localhost:7000/tickets/user/${userId}/event/${eventId}`
...
//                     setUserTicket(ticketData); // Update userTicket state with the fetched ticket data
...
//         // Display the ticket (You need to implement this logic)
//         console.log('Showing ticket:', ticket);
//     };
...
//                                         {ticketFetched && (
//                                             <>
//                                                 {userTicket && userTicket.ticket.length > 0 ? (
        ...
        const fetchUserTicket = async (eventId) => {
            if (auth.user_id) {
                try {
                    const response = await fetch(`http://localhost:7000/tickets/user/${auth.user_id}/event/${eventId}`);
                    const ticketData = await response.json();
                    console.log('Ticket Data:', ticketData.ticket[0]);
